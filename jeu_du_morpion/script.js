        ...
        espacos[i].addEventListener("click", function () {
            ...
            if (this.getElementsByTagName('img').length == 0) {
                if (playTime == player1) {
                    ...
                    this.innerHTML = "<img src='img/x.svg'>"; // si c’est le tour su player1, insérer l’image correspondante au player1, donc X
                    ...
                    this.innerHTML = "<img src='img/o.svg'>"; // si c’est le tour su player2, insérer l’image correspondante au player2, donc O
